...
public class BinaryAPIControllerTest {
    ...
    public void andJson() throws Exception {
        this.mvc.perform(get("/and_json").param("operand1", "001101").param("operand2", "1011"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.operand1").value("1101")) // normalized
    ...
    public void multiplyJson() throws Exception {
        this.mvc.perform(get("/multiply_json").param("operand1", "10a1").param("operand2", "11"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.operand1").value("0")) // invalid -> 0
